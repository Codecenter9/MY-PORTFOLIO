...
import HowWorks from "../service/howworks";

const About = () => {
  return (
    <section
      id="about"
      className={`flex  flex-col about_section text-white justify-between items-center relative overflow-hidden sm:${styles.paddingY} ${styles.paddingX}`}
    >
      ...
      <div className="flex md:flex-row flex-col">
        ...
        >
          ...
          <p className="text-[20px] leading-[28px] sm:w-[85%] text-start">
            ...
            crafting efficient and scalable web solutions. I enjoy solving
            real-world problems through clean, maintainable code and seamless
            user experiences. With a deep understanding of both frontend and
            backend technologies, I strive to build applications that are not
